...
public class ConfigFileDemo {
    public static void main(String[] args) throws IOException {
        ...
        // firs we need to know the path/location of that file
        String path="Files/Config.properties";
        // Navigating to that path where file is stored
        FileInputStream fileInputStream=new FileInputStream(path);
        // we need to have that special software that understand that file that we can use to open and edit that file
